...
console.log(
  "Игра крестики-нолики, всё работает, продолжается до 10 побед одной из сторон, играет финальный трек. Для мобильника также адаптирована. Есть кнопка для выбора другой игры - 'слови хомяка'."
);
